...
import com.codes.quizme.databinding.FragmentWalletBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        database.collection("users")
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                binding.fraCurrentCoin.setText(String.valueOf(user.getCoins()));
        ...
        binding.sendRequestBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(user.getCoins()>50000){
                    ...
                    String payPal = binding.wallEmailBox.getText().toString();
